...
// // const uri = "mongodb+srv://s3980223:<Password>@a4-3980223-Cluster-cluster.pkhgj.mongodb.net/?retryWrites=true&w=majority&appName=a4-3980223-Cluster";

// const uri = "mongodb+srv://s3980223:<db_password>@a4-3980223-cluster.mtdfcqs.mongodb.net/";
...
// // Catch-all route for React (for React Router support)
// app.get('*', (req, res) => {
...
//     const result = await db.collection('Movie').insertOne({ mvNumb, mvTitle, yrMade, mvType, Crit, MPAA, Noms, Awrd, dirNumb });
